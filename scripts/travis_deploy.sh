...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "jonovik/memote-salarecon-6" ]]; then
...
echo "Your new report will be visible at https://jonovik.github.io/memote-salarecon-6 in a moment."
